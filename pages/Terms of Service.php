...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid p-3">
        <h1  class="text-dark ms-5" ;">Terms of Service</h1>
	...
	<div id="bottom-root" class="container-fluid shadow p-0">
          ...
          <div class="container p-3">
      		...
      		<p class="text-secondary mt-3 ">
      			This website is operated by Official TOPK Store - Charging Cables, Magnetic Cables, Wireless Chargers, Wall Chargers, and More!. Throughout the site, the terms “we”, “us” and “our” refer to Official TOPK Store - Charging Cables, Magnetic Cables, Wireless Chargers, Wall Chargers, and More!. Official TOPK Store - Charging Cables, Magnetic Cables, Wireless Chargers, Wall Chargers, and More! offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.   			
      		</p>
        	...
        	<p class="text-secondary ">
        		Certain products or services may be available exclusivel
        	</p>
        	</div>
